...
import 'package:bereke_finance_manager/icon_widgets/circle_painter.dart';
...
class _DetailScreenState extends State<DetailScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    for (var expenses in widget.typeModel!.expenses!) {
  ...
  _buildExpenseList() {
    ...
    for (var expense in widget.typeModel!.expenses!) {
      expenseList.add(
        Container(
          width: 100.w,
          height: 10.h,
