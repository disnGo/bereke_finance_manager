...
class StatsScreen2 extends StatefulWidget {
  const StatsScreen2({Key? key}) : super(key: key);
  
  @override
  StatsScreen2State createState() => StatsScreen2State();

}

class StatsScreen2State extends State<StatsScreen2> {
          ...
          Card(
            ...
            child:
              ...
              leading:
                  ...
                  Colors.green[300], child:
                  const Icon(Icons.add, color:
                  Colors.white)),
              title:
                  const Text('Income', style:
                  TextStyle(fontSize:
                  18, fontWeight:
                  FontWeight.bold, color:
                  Colors.black)),
